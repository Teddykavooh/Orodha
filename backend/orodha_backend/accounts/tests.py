...
class UserManagementTests(TenantTestCase):
    ...
    def test_admin_can_create_and_delete_manager(self):
        create_data = {
        ...
        self.assertTrue(UserProfile.objects.filter(id=created_id, role="MANAGER").exists())
    ...
    def test_admin_can_update_manager_via_put(self):
    ...
    def test_admin_can_get_manager(self):
        create_data = {
