    ...
    def get(self, request, *args, **kwargs):
        ...
        # GENERATE AND STREAM CLEAN CORPORATE PDF
            ...
            try:
                ...
                green_bold_style = ParagraphStyle(
                    'GreenTotalText', 
                    parent=styles['Normal'], 
                    fontName='Helvetica-Bold', 
                    fontSize=10, 
                    textColor=colors.HexColor('#16A34A') # Clean Tailwind Green-600 Hex value
                )

                green_bold_right_style = ParagraphStyle(
                    'GreenTotalAmount', 
                    parent=green_bold_style, 
                    alignment=2 # Force numerical right-alignment alignment match
                )
                ...
                table_data.append([
                    ...
                    "",
                    "",
                    Paragraph("TOTAL", green_bold_style),
                    Paragraph(f"{total_revenue:,.2f}", green_bold_right_style)
                ])
